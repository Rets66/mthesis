...
\etitle{A Study of Name Resolution System to prevent DNS Exfiltration based on Supernode in P2P Networks}
% 英語題目 (in plain text)
%   注: (in LaTeX)と同じ場合は指定する必要なし。
%       この情報は修士論文/課題研究には現れませんが、管理のために必要です。
...
% ===================キーワード===================
\keywords{ドメインネームシステム，情報流出，ネットワークセキュリティ，分散ハッシュテーブル，スーパーノード型ピアツーピア}
...
% ===================Keyword===================
\ekeywords{Domain Name System(DNS), Information Leakage, Network Security, Distributed Hash Table(DHT), Supernode in Peer-to-Peer}
