...
%\newpage
\section{関連研究}
\subsection{トラフィック特徴に基づいた悪性DNSトランザクション検知}
\subsection{ペイロード特徴に基づいた悪性DNSクエリ検知}
\subsection{ポストDNSプロトコルによる緩和策}



%\newpage
\section{提案手法}
\subsection{再起問い合わせにおけるハッシュ関数の適用}
