...
cnoremap  
inoremap  
cabbr : tterm top terminal
let &cpo=s:cpo_save
unlet s:cpo_save
set helplang=ja
set ignorecase
set runtimepath=~/.config/nvim,/etc/xdg/nvim,~/.local/share/nvim/site,/usr/local/share/nvim/site,/usr/share/nvim/site,~/.cache/dein/repos/github.com/Shougo/dein.vim,~/.cache/dein/.cache/init.vim/.dein,/usr/local/Cellar/neovim/0.4.3/share/nvim/runtime,/usr/local/Cellar/neovim/0.4.3/share/nvim/runtime/pack/dist/opt/matchit,~/.cache/dein/.cache/init.vim/.dein/after,/usr/share/nvim/site/after,/usr/local/share/nvim/site/after,~/.local/share/nvim/site/after,/etc/xdg/nvim/after,~/.config/nvim/after
set shiftwidth=1
set splitbelow
set splitright
set noswapfile
